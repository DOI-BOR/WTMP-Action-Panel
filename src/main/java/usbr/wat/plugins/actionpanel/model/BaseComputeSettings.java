...
public abstract class BaseComputeSettings
{
	...
	protected void saveModelAltSettings(Element iterElem)
	{
		...
		{
			entry = iter.next();
			Element entryElem = new Element(getSettingElementString());
	...
	private void loadModelAltSettings(Element iterElem)
	{
		...
		{
			_modelAltSettings.clear();
			List kids = modelAltElem.getChildren(getSettingElementString());
	 ...
	 * @return
	 */
	protected abstract String getSettingElementString();



	/**
	 * get the name of the file where the output DSS collections records get copied to
	 * @return
	 */
	public abstract String getCollectionDssFilename();
}
